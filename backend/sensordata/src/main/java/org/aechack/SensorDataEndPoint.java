...
@ServerEndpoint(value = "/sensor/{uid}", decoders = MessageDecoder.class, encoders = MessageEncoder.class)
public class SensorDataEndPoint {
	private Session session;
	Random rand = new Random(System.currentTimeMillis());
	private static final Set<SensorDataEndPoint> clientEndpoints = new CopyOnWriteArraySet<>();
